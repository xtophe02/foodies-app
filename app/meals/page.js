...
import { getMeals } from "@/utils/db";
import Link from "next/link";
import { Suspense } from "react";

export const metadata = {
  title: "All Meals",
  description: "Browse all the delicious meals created by our community",
};
...
export default function Meals() {
  return (
    <>
      ...
      <Suspense
        fallback={
          <div className="text-center animate-pulse text-3xl">Loading...</div>
        }
      >
        <MealsSuspense />
      </Suspense>
